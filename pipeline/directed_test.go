...
func TestPipeline(t *testing.T) {
	t.Run("MultipleStart", func(t *testing.T) {
		...
		err = pipeline.Start(testutil.NewMockPersister())
		require.NoError(t, err)
...
func TestPipelineStartOrder(t *testing.T) {
	...
	mockOperator2 := testutil.NewMockOperator("operator2")
	mockOperator3 := testutil.NewMockOperator("operator3")
	mockPersister := testutil.NewMockPersister()
	...
	mockOperator1.On("Start", mockPersister).Return(fmt.Errorf("operator 1 failed to start"))
	mockOperator2.On("Start", mockPersister).Run(func(mock.Arguments) { mock2Started = true }).Return(nil)
	mockOperator3.On("Start", mockPersister).Run(func(mock.Arguments) { mock3Started = true }).Return(nil)
...
func TestPipelineStopOrder(t *testing.T) {
	...
	mockOperator1.On("Start", mockPersister).Return(nil)
	mockOperator2.On("Start", mockPersister).Return(nil)
	mockOperator3.On("Start", mockPersister).Return(nil)
